...
となっていることから```'input'```という名前であることがわかります。サイトを参照することが面倒であれば、```net.layers```をコンソールなどに出力することで確認することもできます。
...
[vehicle_recognition.py](https://github.com/JuvenileTalk9/OpenVINO/blob/main/02_画像認識/vehicle_recognition.py)
